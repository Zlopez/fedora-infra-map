...
The sources for fedora-infra-map can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/zlopez/fedora_infra_map
.. _tarball: https://github.com/zlopez/fedora_infra_map/tarball/master
